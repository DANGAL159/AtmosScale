...
func (Municipalities) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tweet_proto_enumTypes[0].Descriptor()
}

func (Municipalities) Type() protoreflect.EnumType {
	return &file_proto_tweet_proto_enumTypes[0]
}
...
func (Weathers) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tweet_proto_enumTypes[1].Descriptor()
}

func (Weathers) Type() protoreflect.EnumType {
	return &file_proto_tweet_proto_enumTypes[1]
}
...
const file_proto_tweet_proto_rawDesc = "" +
	"\n" +
	"\x11proto/tweet.proto\x12\vwethertweet\"\xc5\x01\n" +
...
var (
	...
	file_proto_tweet_proto_rawDescData []byte
)

func file_proto_tweet_proto_rawDescGZIP() []byte {
	file_proto_tweet_proto_rawDescOnce.Do(func() {
		file_proto_tweet_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_tweet_proto_rawDesc), len(file_proto_tweet_proto_rawDesc)))
	})
	return file_proto_tweet_proto_rawDescData
}

var file_proto_tweet_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
func file_proto_tweet_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_tweet_proto_rawDesc), len(file_proto_tweet_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		...
		EnumInfos:         file_proto_tweet_proto_enumTypes,
